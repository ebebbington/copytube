...
const Register = (function () {
  const Methods = (function () {
    function validateInput(): boolean {
      const username: string = document.querySelector<HTMLInputElement>('input[name="username"]').value.toString();
      const email: string = document.querySelector<HTMLInputElement>('input[name="email"]').value.toString();
      const password: string = document.querySelector<HTMLInputElement>('input[name="password"]').value.toString();
      if (
        username === null ||
        username === undefined ||
        username === "" ||
