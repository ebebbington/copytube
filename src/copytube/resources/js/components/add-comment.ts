      ...
      document
        ...
        .addEventListener("keyup", function (event) {
          ...
          if (length > 400) {
            ...
            document.querySelector<HTMLParagraphElement>(
              "#comment > span > p"
            ).style.color = "var(--custom-dark-grey";
          }
          document.querySelector<HTMLParagraphElement>(
            "#comment > span > p"
          ).textContent = "length";
      ...
      document
        ...
        .addEventListener("click", function () {
          ...
          const comment = document
            .querySelector<HTMLTextAreaElement>("#comment > span > textarea")
            .value.toString();
          const datePosted = getCurrentDate();
          // ajax
          const videoPostedOn: string = document
            .querySelector("#main-video-holder > video")
            .getAttribute("title");
