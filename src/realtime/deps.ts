...
import { config } from "https://deno.land/x/dotenv@v0.5.0/dotenv.ts";
export {
    config
};
...
export { connect } from "https://deno.land/x/redis@v0.12.0/redis.ts";

export { assertEquals } from "https://deno.land/std@v0.65.0/testing/asserts.ts";
